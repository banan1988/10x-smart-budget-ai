...
describe("useAiStatsAdmin hook", () => {
  ...
  it("should handle API errors gracefully", async () => {
    ...
    expect(result.current.error?.message).toContain(errorMessage, "Error message should contain server error");
  ...
  it("should update date range and refetch", async () => {
    ...
    expect(result.current.dateRange).toEqual(newDateRange, "Date range should be updated");
  ...
  it("should initialize with provided initial date range", async () => {
    ...
    expect(result.current.dateRange).toEqual(initialDateRange, "Should initialize with provided date range");
  ...
  it("should handle 401 unauthorized error", async () => {
    ...
    expect(result.current.error?.message).toContain(
      "Unauthorized access",
      "Error message should contain authorization error"
    );
