...
describe("DateRangeFilter Component", () => {
  ...
  it("should render date inputs and buttons", () => {
    render(<DateRangeFilter onDateRangeChange={mockOnDateRangeChange} showPresets={true} />);
  ...
  it("should not display preset buttons when showPresets is false", () => {
    render(<DateRangeFilter onDateRangeChange={mockOnDateRangeChange} showPresets={false} />);
  ...
  it("should apply preset and call callback on preset button click", async () => {
    ...
    render(<DateRangeFilter onDateRangeChange={mockCallback} showPresets={true} />);
  ...
  it("should disable buttons when isLoading is true", () => {
    render(<DateRangeFilter onDateRangeChange={mockOnDateRangeChange} isLoading={true} />);
